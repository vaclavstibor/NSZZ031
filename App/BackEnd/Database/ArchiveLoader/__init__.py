...
if __name__ == "__main__":
    ...
    for i in range(1,2):
        Transaction.load_file(archive_loader, f"2022-{i}.json")
        print(f"2022-{i}.json has been loaded.")
    for i in range(1, 13):
        Transaction.load_file(archive_loader, f"/business/2022-{i}.json")
        print(f"/business/2022-{i}.json has been loaded.")
