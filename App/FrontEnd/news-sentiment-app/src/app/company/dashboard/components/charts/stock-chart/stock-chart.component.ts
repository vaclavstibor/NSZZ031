...
export class StockChartComponent implements OnInit {
  ...
  getStockChartOptions(mappedData?: { pricePoints: any[], positivePoints: any[], negativePoints: any[], neutralPositivePoints: any[], neutralNegativePoints: any[] }) {
      this.chartOptions = {
  ...
  mapDataToChart(priceData: any[], sentimentData: any[]) {
      ...
      const positivePoints: { x: Date; y: any }[] = [];
      const negativePoints: { x: Date; y: any }[] = [];
      const neutralPositivePoints: { x: Date; y: any }[] = [];
      const neutralNegativePoints: { x: Date; y: any }[] = [];
