        ...
        with connection.cursor() as cursor:
            ...
            for ticker in tickers:
                ...
                if company_id:
                    ...
                    additional_data = {key: company_info.get(key, None) for key in keys_of_interest}

                    # If fetched data is not empty
                    # is not a number check due to some of bug in Yahoo Finance library TODO: jestli funguje
                    if any(additional_data.values()) and additional_data['shortName'].isdigit() is not True:
