...
def get_company_article_list(connection: psycopg2_connection, ticker: str, table_prefix: str) -> list:
    """
    Fetches a company's all articles from a database. The articles are sorted by their published date in descending order. 
    ...
    Returns:
        list: A list of dictionaries, where each dictionary contains 'id', 'title', 'published_date', 'url', 'author', 'type', 'section', and 'sentiment' keys for an article.
    """
